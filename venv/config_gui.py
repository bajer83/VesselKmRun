...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tCPListeningPortSpinBox.setMinimum(1500)
        self.tCPListeningPortSpinBox.setMaximum(65000)
        self.tCPListeningPortSpinBox.setProperty("value", 1500)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.start_server_btn.setText(_translate("Dialog", "Start server"))
